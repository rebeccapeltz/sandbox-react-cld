...
export default function App() {
  ...
  // use toURL() to create a URL and use it in an HTML image element
  const cloudinaryImage = new CloudinaryImage("sample2", { cloudName: "picturecloud7" })
...
const cloudinaryVideo = new CloudinaryVideo("<my public id>", { cloudName: "<my cloud name>" })
        ...
        instructions={[
          ...
          `Try some of these other public IDs from the "cloudinary-training" cloud: sample1-3, sample1-5`
        ]}
      />
