...
export default function App() {
  ...
  const myImage = cld.image('sample1').resize(fill().width(350).height(350).gravity("auto"));
  return (
    <div>
...
export default function AddingTransformations() {
  ...
  // create a new object and apply the outline to the new object
    const myImage2 = cld.image('sample1').resize(fill().width(350).height(350).gravity("auto"));
      return (
        <div>
          <AdvancedImage cldImg={myImage.effect(cartoonify())} />
