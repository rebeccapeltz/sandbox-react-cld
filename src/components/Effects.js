...
export default function App() {
  ...
  const cldImage = cld.image('sample1').resize(thumbnail().width(150).height(150).gravity("face"));
  const cldBlur = cld.image('sample1').resize(thumbnail().width(150).height(150).gravity("face")).effect(blur().strength(800));
  const cldContrast = cld.image('sample1').resize(thumbnail().width(150).height(150).gravity("face")).adjust(contrast().level(100));
...
export default function App() {
  ...
  const cldGrayScale = cld.image('sample1').resize(thumbnail().width(150).height(150).gravity("face")).effect(grayscale());
  const cldSepia = cld.image('sample1').resize(thumbnail().width(150).height(150).gravity("face")).effect(sepia());
  const cldBlackWhite = cld.image('sample1').resize(thumbnail().width(150).height(150).gravity("face")).effect(blackwhite());
