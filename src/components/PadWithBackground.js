...
const cld = new Cloudinary({ cloud: {cloudName: "picturecloud7"}});
const cldVideo = cld.video('snow').resize(pad().width(300).height(400).background(color("#ff0000")));
export default function App() {
  return (
    <div className="App">
...
export default function PadWithBackground() {
  return (
    <div className="code-container">
      ...
      <Experiment
        codeString={`const cldImage = cld.image('sample1').resize(pad().width(350).height(200));
return (
  <div>
...
const cldVideo = cld.video('snow').resize(pad().width(300).height(400));
